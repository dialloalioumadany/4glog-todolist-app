...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _loadTodos() async {
    ...
    if (todosString != null) {
      ...
      setState(() {
        _todos = [
          _Todo('This is an example of task #1', true),
          _Todo('This is an example of task #2', false),
          _Todo('This is an example of task #3', true),
          _Todo('This is an example of task #4', false),
          _Todo('This is an example of task #5', false),
        ];
      });
      _saveTodos();
    }
  ...
  Future<void> _saveTodos() async {
    final prefs = await SharedPreferences.getInstance();
    final String todosString = jsonEncode(_todos.map((e) => e.toJson()).toList());
                ...
                Expanded(
                  child: Container(
                    ...
                    child: SingleChildScrollView(
                      child: Text(
                        todo.content.isEmpty ? 'Aucun contenu' : todo.content,
                        style: const TextStyle(fontSize: 16),
                      ),
                    ),
                  ),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 18),
                Text(
                  'Il vous reste : $remaining tâches restantes',
                  style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 15),
                ),
                const SizedBox(height: 8),
                const Text(
                  '"Rester focus est ce qui vous permet d\'atteindre vos objectifs" - Aliou Madany',
