              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: _loading
                        ? const Center(child: CircularProgressIndicator(color: Color(0xFF3576EC)))
                        : ElevatedButton(
                            onPressed: _login,
                            child: const Text('Connexion', style: TextStyle(fontSize: 17)),
                            style: ElevatedButton.styleFrom(
                              backgroundColor: const Color(0xFF3576EC),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 18),
                      _SocialButton(
                        icon: Icon(Icons.facebook, color: Color(0xFF1877F3), size: 28),
                        color: Colors.white,
                        borderColor: Colors.grey.shade300,
                        onTap: () {},
                      ),
